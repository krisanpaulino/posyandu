            ...
            <?php if (session('user')->user_type == 'admin') : ?>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url(session('user')->user_type . '/hasilukur/' . $periode->periode_id . '/posyandu/' . $posyandu->posyandu_id) ?>"><?= $posyandu->posyandu_nama ?></a></li>
                        <li class="breadcrumb-item active"><?= $title ?></li>
                    </ol>
                </div>
            <?php endif; ?>
